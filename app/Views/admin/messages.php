<section class="container page-shell">
  ...
  <p class="section-subtitle">Review incoming support inquiries and keep inbox clean.</p>
  ...
  <?php else: ?>
    <div class="table-responsive">
      <table id="messages-table" class="table table-sm table-striped align-middle">
