<section class="container py-5">
  ...
  <div class="admin-toolbar d-flex flex-wrap gap-2 align-items-center justify-content-between">
    <p class="mb-0 text-muted">Quick links for daily operations.</p>
  ...
  <div class="row g-3 mb-4">
    <div class="col-md-3"><div class="card stat-card"><p class="label">Total Users</p><h2 class="metric"><?= (int)$totalUsers ?></h2></div></div>
    <div class="col-md-3"><div class="card stat-card"><p class="label">Active Memberships</p><h2 class="metric"><?= (int)$activeMemberships ?></h2></div></div>
    <div class="col-md-3"><div class="card stat-card"><p class="label">Total Bookings</p><h2 class="metric"><?= (int)$totalBookings ?></h2></div></div>
    <div class="col-md-3"><div class="card stat-card"><p class="label">Most Popular Class</p><h2 class="h6 mb-0"><?= e($popularClass) ?></h2></div></div>
  </div>
  <div class="d-flex flex-wrap gap-2">
