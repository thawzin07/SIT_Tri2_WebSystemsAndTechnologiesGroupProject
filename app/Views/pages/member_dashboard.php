<section class="container page-shell">
  ...
  <div class="card p-3 mb-4" id="my-waitlist">
              ...
              <tr>
                ...
                <td>
                  <form action="/member/bookings/waitlist/cancel" method="post">
                    ...
                    <input type="hidden" name="redirect_to" value="/member/dashboard#my-waitlist">
  ...
  <div class="card p-3" id="my-bookings">
                ...
                <td>
                  <?php if ($booking['booking_status'] === 'booked'): ?>
                    <form action="/member/bookings/cancel" method="post">
                      ...
                      <input type="hidden" name="redirect_to" value="/member/dashboard#my-bookings">
